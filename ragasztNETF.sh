...
konyvtar="/media/Lubuntuuuuu/VirtualBoxDisks_12_10_old_LUBUNTU/transfer/f/higstock_dwn/examples/basic-line.data/NETFONDS_feldolgozas/"
...
cgi="checkout.sh"
curl http://89.134.14.161:8008/cgi-bin/$cgi\?namex=$sorok_szama\&namey=orvos\&namez=$ticker\&KONYVT=$KONYVT | grep "\["  >> $konyvtar""$ticker
...
###scp -P 2233 fujilakare8@89.134.14.161:/var/www/netfonds.utc/UTC_zes_netfondson/fardigJS/*.js $konyvtar 

###wget http://89.134.14.161:8008/netfonds.utc/UTC_zes_netfondson/fardigJS/AAK.js -O ./xxx
###cat ./xxx | wc -l
