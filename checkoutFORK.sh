...
echo "checkoutFORK     kapott \$1::$1"
echo "checkoutFORK     ARGX  $ARGX ;;  ARGY  $ARGY  ;;  ARGZ  $ARGZ    " #>>/var/www/omx.utc.ark/checkout/log
echo "checkoutFORK     1" $1" ;; 2 "$2"  ;;  3  "$3     #>>/var/www/omx.utc.ark/checkout/log
#echo "<hr>"
...
echo "checkoutFORK     Parsed Values:<br>ARGX:"$ARGX  " <br> ARGY:"$ARGY    "<br>ARGZ:"$ARGZ
  echo ""
